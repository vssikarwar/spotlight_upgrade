...
<section class="content">
    <div class="row">
        <div class="col-xs-12">
            <div class="box">
                <div class="box-body">                                        
                    <form class="form" action="{{ route('States.addData')}}" method="POST">
                        {{@csrf_field()}}
                        <fieldset>
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="input select"><select name="alias" class="form-control" value="{{ old('alias') }}"  id="states-alias">
                                        <!-- <option value="">---SELECT---</option> -->
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="input text">
                                        <input type="text" name="name" class="form-control" maxlength="55" value="{{ old('name') }}" id="states-name"/>
                                    </div> 
                                    @if ($errors->has('name'))
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input text">
                                        <input type="text" name="state_code" class="form-control" maxlength="2" value="{{ old('state_code') }}" id="countries-iso-alpha-2" />
                                    </div>   
