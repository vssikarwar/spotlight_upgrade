            ...
            <div class="box">
                <div class="box-body">                                        
                    <form class="form" action="{{ route('AffinityCategories.addData')}}" method="POST">
                        ...
                        <fieldset>
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group ">                                
                                    ...
                                    <label for="affinitycategories-status"><input type="checkbox" name="status" value="1" id="affinitycategories-status" checked="checked">Status</label>
                                </div>                            
                                </div>
                            </div>
                        ...
                        <button class="btn btn-primary" id="addaffinityCategorySubmitBtn" type="submit">Submit</button> 
